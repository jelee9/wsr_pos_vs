...
namespace wsr_pos
{
	...
	public partial class MenuItemCanvas : UserControl
	{
		...
		private void setTestData()
		{
			...
			Item item06 = new Item(1,	06, "밴드 웨곤",			"",							20000, false, false, false, 3, 0, MetrialColor.Name.Blue);
			Item item07 = new Item(1,	07, "더블땅콩",			"",							25000, false, false, false, 2, 1, MetrialColor.Name.Blue);
			Item item08 = new Item(1,	08, "디스코팡팡",			"",							25000, false, false, false, 3, 1, MetrialColor.Name.Blue);
			Item item09 = new Item(1,	09, "뉴 디스코팡팡",		"",							25000, false, false, false, 4, 1, MetrialColor.Name.Blue);
			Item item10 = new Item(1,	10, "헥사곤",				"",							25000, false, false, false, 5, 1, MetrialColor.Name.Blue);
			Item item11 = new Item(1,	11, "마블",				"",							25000, false, false, false, 2, 2, MetrialColor.Name.Blue);
			Item item12 = new Item(1,	12, "날으는 바나나",		"",							25000, false, false, false, 3, 2, MetrialColor.Name.Blue);

			Item item13 = new Item(1,	13, "보팅 (A)",			"",							50000, false, false, false, 2, 3, MetrialColor.Name.Blue);
			Item item14 = new Item(1,	14, "보팅 (B)",			"",							100000, false, false, false, 3, 3, MetrialColor.Name.Blue);
			Item item15 = new Item(1,	15, "보팅 (C)",			"",							150000, false, false, false, 4, 3, MetrialColor.Name.Blue);


			Item item16 = new Item(2,	16, "물놀이 패키지 1",		"마블/바나나/밴드웨곤 2종",		28000, false, false, false, 6, 0, MetrialColor.Name.DeepOrange);
			Item item17 = new Item(2,	17, "물놀이 패키지 2",		"물놀이 2종",					30000, false, false, false, 7, 0, MetrialColor.Name.DeepOrange);
			Item item18 = new Item(2,	18, "물놀이 패키지 3",		"물놀이 3종",					45500, false, false, false, 6, 1, MetrialColor.Name.DeepOrange);
			Item item19 = new Item(2,	19, "물놀이 패키지 4",		"물놀이 4종",					59500, false, false, false, 7, 1, MetrialColor.Name.DeepOrange);
			Item item20 = new Item(2,	20, "수상 패키지 1",		"수상스키 2회 + 물놀이",		61000, false, false, false, 6, 3, MetrialColor.Name.DeepOrange);
			Item item21 = new Item(2,	21, "수상 패키지 2",		"수상스키 2회 + 물놀이 2종",	73500, false, false, false, 7, 3, MetrialColor.Name.DeepOrange);
